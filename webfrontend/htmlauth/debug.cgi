...
V=html.escape(version());print(f'<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Fire TV Debug</title>{CSS}</head><body><div class="root"><div class="head"><div class="logo">▤</div><div class="title"><h1>Debug & Log</h1><p>Diagnoseinformationen und Fire-TV-Protokoll</p></div><div class="ver">Version {V}</div></div><div class="mobile"><a href="index.cgi">⌂ Übersicht</a><a href="config.cgi">⚙ Einstellungen</a><a href="discover.cgi">⌕ Suche</a><a href="security.cgi">🔒 Sicherheit</a><a href="/admin/index.cgi">← LoxBerry</a></div><div class="layout"><nav class="nav"><small>Fire TV Control</small><a href="index.cgi">⌂ Übersicht</a><a href="discover.cgi">⌕ Fire TVs suchen</a><div class="sep"></div><a href="config.cgi">⚙ Einstellungen</a><a href="security.cgi">🔒 Security Center</a><a class="active" href="debug.cgi">▤ Debug-Log</a><div class="sep"></div><a href="/admin/index.cgi">← Zurück zu LoxBerry</a></nav><main>')
if msg:print('<div class="notice">%s</div>'%html.escape(msg))
if err:print('<div class="notice err">%s</div>'%html.escape(err))
print('<section class="card"><h2>Systemstatus</h2><div class="body"><div class="grid"><div class="metric"><small>LoxBerry Loglevel</small><b>%s (%s)</b></div><div class="metric"><small>MQTT</small><b>%s</b></div><div class="metric"><small>Watchdog</small><b>%s</b></div><div class="metric"><small>Pluginordner</small><b>%s</b></div></div><p class="muted">Den Loglevel stellst du zentral in der LoxBerry-Pluginverwaltung ein. Für Fehlersuche „Debug“ wählen, im Normalbetrieb „Info“ oder „Warning“.</p></div></section>'%(html.escape(llname),ll,'Aktiv' if c.get('mqtt',{}).get('enabled',True) else 'Aus','Aktiv' if c.get('watchdog',{}).get('enabled',True) else 'Aus',html.escape(FOLDER)))
