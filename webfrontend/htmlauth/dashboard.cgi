...
if os.environ.get('REQUEST_METHOD','GET').upper()=='POST':
 try:
  ...
  allowed={'home','back','up','down','left','right','ok','menu','playpause','volumedown','mute','volumeup','tvon','tvoff','app'}
