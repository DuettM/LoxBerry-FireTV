...
V=html.escape(version());print(f'<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Fire TV Security</title>{CSS}</head><body><div class="root"><div class="head"><div class="logo">🔒</div><div class="title"><h1>Security Center</h1><p>Sicherheitsstatus und MQTT-Berechtigungen</p></div><div class="ver">Version {V}</div></div><div class="mobile"><a href="dashboard.cgi">⌂ Übersicht</a><a href="config.cgi">⚙ Einstellungen</a><a href="discover.cgi">⌕ Suche</a><a href="debug.cgi">▤ Debug</a></div><div class="layout"><nav class="nav"><small>Fire TV Control</small><a href="dashboard.cgi">⌂ Übersicht</a><a href="discover.cgi">⌕ Fire TVs suchen</a><div class="sep"></div><a href="config.cgi">⚙ Einstellungen</a><a class="active" href="security.cgi">🔒 Security Center</a><a href="debug.cgi">▤ Debug-Log</a></nav><main>')
