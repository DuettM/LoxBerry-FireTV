...
def plugin_version():
 try:
  p=os.path.join(root(),'config','plugins',FOLDER,'config.json')
...
</style></head><body><div class="root"><div class="head"><div class="logo"><svg viewBox="0 0 64 64"><rect x="8" y="12" width="48" height="34" rx="5" fill="none" stroke="white" stroke-width="4"/><path d="M28 22v14l13-7z" fill="white"/><path d="M24 52h16" stroke="white" stroke-width="4" stroke-linecap="round"/></svg></div><div class="title"><h1>Fire TV Control</h1><p>Fire TV Geräte steuern und in Loxone integrieren</p></div><div class="ver">Version __VER__</div></div><div class="mobile"><a href="index.cgi">⌂ Übersicht</a><a href="config.cgi">⚙ Einstellungen</a><a href="discover.cgi">⌕ Suche</a><a href="security.cgi">🔒 Sicherheit</a></div><div class="layout"><nav class="nav"><small>Fire TV Control</small><a class="active" href="index.cgi">⌂ Übersicht</a><a href="discover.cgi">⌕ Fire TVs suchen</a><div class="sep"></div><a href="config.cgi">⚙ Einstellungen</a><a href="security.cgi">🔒 Security Center</a><a href="debug.cgi">▤ Debug-Log</a></nav><main class="content">'''.replace('__VER__',html.escape(VERSION)))
